...
# 任务族在总分中的权重（Σ = 1.0）。
# 注意：当前配置为 2026-09 多基座对照用的"演示权重"——对照只评测了
# T3/T5/T6/T7/T8 五个族，权重已在已评测族内重新归一化（T1/T2/T4 未评测，暂置 0，
# 补测后恢复）。默认方法论权重：T1 0.18 / T2 0.12 / T3 0.12 / T4 0.16 /
# T5 0.14 / T6 0.10 / T7 0.10 / T8 0.08（见本文件 git 历史）。
FAMILY_WEIGHTS: dict[str, float] = {
    "T1": 0.0, "T2": 0.0, "T3": 0.01, "T4": 0.0,
    "T5": 0.884, "T6": 0.01, "T7": 0.086, "T8": 0.01,
}
