...
族权重 w 采用**当前多基座对照口径**：只评 LLM 参与的任务族，T3（纯检索）不计分、仅诊断，T1/T2/T4 未评测暂为 0。
默认方法论权重（T1 0.18 / T2 0.12 / T3 0.12 / T4 0.16 / T5 0.14 / T6 0.10 / T7 0.10 / T8 0.08）见 schema.py git 历史。
